    ...
    <div class="container pb-5" style="margin-top:100px;">
        ...
        <!-- Content Area -->
            <div class="col-lg-5 col-md-7">
                <div class="card">
                    <form action="{{ url('/kriteria/'.$kriterium->id) }}" method="POST">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" type="text" name="kriteria" value="{{$kriterium->kriteria}}" placeholder="nama kriteria">
                            </div>
                            <div class="form-group">
